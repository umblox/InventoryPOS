...
sealed class Screen(val route: String) {
    ...
    // --- Purchase Order (PO) Screens ---
    object SmartPo : Screen("smart_po")
    object PoList : Screen("po_list")
    object PoDetail : Screen("po_detail/{poId}") {
        fun createRoute(poId: Long) = "po_detail/$poId"
    }
}
