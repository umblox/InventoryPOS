...
fun SalesReportScreen(navController: NavController) {
    val subMenus = listOf(
        "Daily Report" to Screen.SalesDaily.route,
        "Monthly Report" to Screen.SalesMonthly.route,
        "By Product" to Screen.SalesByProduct.route
    )
            ...
            subMenus.forEach { (title, route) ->
                Card(
                    ...
                    Row(
                        ...
                        Text(text = title, style = MaterialTheme.typography.titleMedium, color = PremiumTextPrimary)
